...
(Risk1:RISK{name:  "BRISK1", Risk_Descrpt:"Falling to the ground during equipment transportation", Risk_pro:0.3,  Risk_imp:0.5}),
(Risk2:RISK{name:  "BRISK2",Risk_Descrpt:"Incorrect installation of drill frame", Risk_pro:0.3,  Risk_imp:0.5}),
(Risk3:RISK{name:  "BRISK3", Risk_Descrpt:"Insufficient insertion depth of the protective tube", Risk_pro:0.3,  Risk_imp:0.5}),
